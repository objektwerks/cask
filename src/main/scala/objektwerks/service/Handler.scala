...
class Handler(service: Service):
  def handle(command: Command): Event =
    command match
      ...
      case add: AddSurface =>
        service.addSurface(add.surface).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddPump =>
        service.addPump(add.pump).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddTimer =>
        service.addTimer(add.timer).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddTimerSetting =>
        service.addTimerSetting(add.timerSetting).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddHeater =>
        service.addHeater(add.heater).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddHeaterSetting =>
        service.addHeaterSetting(add.heaterSetting).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddMeasurement =>
        service.addMeasurement(add.measurement).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddCleaning =>
        service.addCleaning(add.cleaning).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddChemical =>
        service.addChemical(add.chemical).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddSupply =>
        service.addSupply(add.supply).fold(throwable => Fault(throwable), entity => event.Added(entity))
      ...
      case add: AddRepair =>
        service.addRepair(add.repair).fold(throwable => Fault(throwable), entity => event.Added(entity))
